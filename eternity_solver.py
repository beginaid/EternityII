...
Original file is located at
    https://colab.research.google.com/drive/1srIjO6SpxEyCcdK3DczCjdj8_pYa2iXH
"""
...
color_code = making_color(color)
draw_puzzle(answer, "answer", color_code)
...
draw_puzzle(X, "input", color_code)
IPython.display.Image("input.png")

Y = solve(X)

draw_puzzle(Y, "output", color_code)
IPython.display.Image("output.png")

score = (check(Y)/(N*4)) * 100
